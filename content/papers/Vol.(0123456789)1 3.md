...
## Key Concepts
- Value Sensitive Design (VSD) — tripartite methodology (conceptual, empirical, technical investigations)
- AI for social good principles
- Stakeholder analysis in AI development
- Value conflicts in sociotechnical systems
- Proactive ethics in technology design

## Theoretical Framework
Value Sensitive Design (Friedman, Kahn, and Borning); AI ethics frameworks; normative technology design theory; draws on participatory design and technology ethics literature.

## Methods
Conceptual mapping; case analysis applying VSD methodology to AI-for-social-good scenarios; literature review of both VSD applications and AI ethics frameworks.

## Main Arguments
- "AI for social good" initiatives often lack rigorous methodology for identifying and operationalizing relevant values
- VSD's three-part investigation (conceptual, empirical, technical) provides a systematic approach to value integration
- Applying VSD to AI contexts requires extensions to handle algorithmic systems' scale, opacity, and emergent behavior
- Early-stage value embedding through VSD is more effective and less costly than post-hoc ethics review
