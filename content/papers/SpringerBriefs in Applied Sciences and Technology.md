...
## Key Concepts
- UX evaluation of AI-integrated systems
- Trust and transparency as UX dimensions
- Controllability and predictability in AI UX
- Multi-dimensional AI UX framework
- Evaluation methodology for probabilistic systems

## Theoretical Framework
User experience theory; AI interaction design; trust in automation; draws on Hassenzahl's UX model, Norman's Gulf of Evaluation/Execution, and human factors research on trust in automation.

## Methods
Framework development; evaluation case studies; expert review and application of the methodology to AI-integrated product evaluations.

## Main Arguments
- Traditional UX evaluation methods are insufficient for AI systems because they assume deterministic, predictable system behavior
- AI UX requires additional evaluation dimensions: trust, transparency, user agency, and predictability must be explicitly assessed
- The proposed framework provides structured guidance for UX practitioners who need to evaluate AI-integrated products but lack AI-specific methods
- Early evaluation of AI UX qualities prevents costly redesign when trust or controllability failures emerge in deployment
